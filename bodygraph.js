...
const GO = {
  ...
  Throat:{8:[0,54],12:[53,0],16:[-53,-33],20:[-53,24],23:[0,-54],31:[-27,44],33:[27,44],35:[53,-33],45:[53,27],56:[27,-44],62:[-27,-44]},
  ...
  Spleen:{18:[-22,39],28:[0,22],32:[26,12],44:[27,-13],48:[-21,-50],50:[54,0],57:[3,-27]},
  SolarPlexus:{6:[-54,0],22:[-3,-27],30:[21,37],36:[21,-23],37:[-26,-13],49:[-25,11],55:[-1,23]},
};
...
function generateBodygraph(data){
  ...
  Object.entries(GO).forEach(function(entry){
    ...
    Object.entries(gates).forEach(function(ge){
      ...
      const fill=gold?PC.gG:(isDef?'#FFFFFF':PC.cU);
      const tf=gold?PC.gGT:(isDef?'#7A5020':'#A08060');
